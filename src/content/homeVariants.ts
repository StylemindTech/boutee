...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "value-for-money": createVariant({
    ...
    hero: {
      ...
      ctaLabel: "Find Quality Jewellers",
    },
    process: {
  ...
  "trusted-jewellers": createVariant({
    hero: {
      ...
      ctaLabel: "See Trusted Jewellers",
    },
    process: {
  ...
  "bespoke-rings": createVariant({
    hero: {
      ...
      ctaLabel: "Start The Bespoke Journey",
    },
    process: {
      heading: "Your bespoke ring, designed the right way",
      steps: [
        { title: "Define Your Style", description: "Swipe through rings to understand the design elements you’re drawn to — shape, proportion, setting, details. We’ll turn your taste into a clear Style Profile that reflects the bespoke direction you’re imagining." },
        { title: "See Your Matches", description: "We then recommend independent jewellers whose design profile match your style. These are accomplished makers with strong creative identities." },
        { title: "Start a Conversation", description: "Message your chosen jeweller directly. Discuss ideas, materials, gemstones, proportions. It’s a collaborative process, and you’ll refine the concept together until you're happy." },
      ],
    },
    why: {
      ...
      cardOne: "Every Boutee jeweller works from their own studio, <strong>crafting each ring from scratch.</strong> Nothing is factory-made or mass-produced — just <strong>careful workmanship from the first sketch to the final polish.</strong>",
      cardTwo: "You’re matched with <strong>a jeweller whose style fits yours,</strong> so your ideas feel understood from the start. They guide you through details, proportions and materials with <strong>clarity and honesty.</strong>",
      cardThree: "By working directly with the maker, <strong>your budget goes into the ring itself — not retail mark-ups</strong> or branding. You get higher craftsmanship and better materials for the same spend you’d make at a big-name retailer.",
      ctaLabel: "Get Started",
      ctaHref: "/app",
    },
    bespoke: {
      heading: "Considering a bespoke ring?",
      intro: "You'll need:",
      budgetDescription: "At least £1000 to ensure high-quality materials, careful design and meticulous making.",
