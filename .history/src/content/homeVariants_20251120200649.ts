...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "find-her-style": createVariant({
    hero: {
      badgeText: "60+ expert jewellers",
      heading: "Find Her Ring Style — With Total Confidence",
      body: "Not sure what she’ll like? You’re not alone. Most men worry about choosing the wrong ring. Boutee makes it simple: swipe through designs you love and we’ll build a Style Profile that clearly shows what suits her. Then we match you with independent jewellers who specialise in that exact style.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
    ...
    why: {
      ...
      cardOne: "Our jewellers are independent craftspeople — real humans, not retail salespeople — who work in small studios and understand style down to the smallest detail.",
      cardTwo: "If you’re unsure about shapes, settings or stones, they guide you with zero judgement.",
      cardThree: "And because you’re working directly with the maker, you skip the retail mark-up and get a higher-quality ring for your budget.",
      ctaLabel: "Get Started",
      ctaHref: "/app",
    },
    bespoke: {
