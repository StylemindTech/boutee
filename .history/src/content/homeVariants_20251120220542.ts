...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "custom-rings": createVariant({
    ...
    process: {
      ...
      steps: [
        { title: "Discover What You Like", description: "Swipe through ring designs and “like” the ones that stand out. You don’t need the perfect brief — you’re just showing us the shapes, details and styles that feel right." },
        { title: "See Your Jeweller Matches", description: "We then suggest independent jewellers whose work fits your style and budget. You’ll see their past custom pieces, so you can picture the kind of ring they could make for you." },
        { title: "Chat and Design Together", description: "When you’re ready, message the jeweller you like most. They’ll help you shape the design — from first sketch to final details — in clear, simple language. No experience needed; you bring the idea, they bring the craft." },
      ],
    },
    why: {
      heading: "Go direct to the maker",
      body: "A custom ring shouldn’t come from a production line.",
      cardOne: "Boutee brings together some of <strong>the UK’s most talented independent jewellers.</strong> They work from their own small studios, <strong>handcraft each ring,</strong> and care about the <strong>story behind it.</strong>",
      cardTwo: "Because you’re working directly with the maker, <strong>you’re not paying for shop rent, sales staff or glossy displays.</strong> More of your budget goes into the ring itself — better materials, better finishing, better details.",
      cardThree: "Bring them your Pinterest board, a rough idea, or just a vibe. They’ll <strong>guide you through stone choices, metals and design tweaks</strong> until you land on a ring that feels “this is it”.",
      ctaLabel: "Build My Style Profile",
      ctaHref: "/app",
    },
    bespoke: {
      heading: "Is a custom ring right for you?",
      intro: "If you’re thinking about a custom engagement ring, you'll need:",
      budgetDescription: "for quality materials and proper craftsmanship.",
      timeDescription: "from first chat to finished ring, as everything is made to order.",
    },
    testimonials: {
      heading: "Real people, real ideas, turned into custom rings",
    },
    cta: {
      heading: "Ready to start your custom ring?",
      body: "Create your free Style Profile to see which jewellers are the best fit for your taste, budget and ideas. Explore their work, chat through options, and design a ring together — without needing to be a designer yourself.",
      buttonLabel: "Get Started for Free",
      buttonHref: "/app",
    },
  }),
  "bespoke-rings": createVariant({
    ...
    process: {
      ...
      steps: [
        { title: "Define Your Style", description: "Swipe through rings to understand the design elements you’re drawn to — shape, proportion, setting, details. You don’t need to know the terminology; your instinct is enough. We’ll turn your taste into a clear Style Profile that reflects the bespoke direction you’re imagining." },
        { title: "See Your Matches", description: "We then introduce you to independent jewellers whose design sensibilities match your style. These are accomplished makers with strong creative identities — the kind of people who can elevate an idea into a piece of art." },
        { title: "Start a Conversation", description: "Message your chosen jeweller directly. Discuss ideas, materials, gemstones, proportions. This isn’t retail service — it’s a designer guiding you through a collaborative process. You’ll refine the concept together until it becomes the ring you had in mind (or better)." },
      ],
    },
    why: {
      heading: "Work With the Jeweller Who Actually Makes the Ring",
      body: "When you choose a bespoke ring, the difference is in who you work with.",
      cardOne: "Every Boutee jeweller works from their own studio, crafting each ring from scratch. Nothing is factory-made, nothing is mass-produced — just careful workmanship from the first sketch to the final polish.",
      cardTwo: "You’re matched with a jeweller whose style fits yours, so your ideas feel understood from the start. They guide you through details, proportions and materials with clarity, not sales talk.",
      cardThree: "By working directly with the maker, your budget goes into the ring itself — not retail mark-ups or branding. You get higher craftsmanship for the same spend you’d make at a big-name retailer.",
      ctaLabel: "Start Your Style Profile",
      ctaHref: "/app",
    },
    bespoke: {
      heading: "Considering a Bespoke Ring?",
      intro: "You'll need",
      budgetDescription: "At least £1000 to ensure high-quality materials, thoughtful design and meticulous making.",
      timeDescription: "Your ring is created from scratch, so the process takes time.",
    },
    testimonials: {
      heading: "Bespoke Rings Made by Independent Designers",
      subheading: "Real couples. Real craft. Rings that couldn’t have come from a display case.",
    },
    cta: {
      heading: "Ready to Begin Your Bespoke Ring?",
      body: "Create your free Style Profile to discover jewellers whose design vision aligns with yours. Compare their work, start a conversation, and collaborate directly with the maker who feels right.",
      buttonLabel: "Get Started for Free",
      buttonHref: "/app",
    },
  }),
