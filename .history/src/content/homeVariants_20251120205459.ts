...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "no-sales-pressure": createVariant({
    hero: {
      ...
      body: "There's nothing worse than feeling like you're being sold an engagement ring. On Boutee, you explore designs, figure out what you like, and speak directly with the person who’ll make the ring — not someone trying to sell you one.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
