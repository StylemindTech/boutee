...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "find-her-style": createVariant({
    ...
    why: {
      ...
      cardThree: "And because you’re working <strong>directly with the maker</strong>, you skip the retail mark-up and get a <strong>higher-quality ring for your budget.</strong>",
      ctaLabel: "Get Started",
      ctaHref: "/app",
    },
    bespoke: {
