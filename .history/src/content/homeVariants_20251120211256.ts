...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "custom-rings": createVariant({
    hero: {
      ...
      heading: "Create a Custom Ring, Without Needing to Be a Designer",
      body: "You have the idea. She deserves something personal. You don’t need to know all the jargon. With Boutee, you swipe through rings to discover what you like, then we match you with an independent jeweller who can turn that into a custom ring — step by step.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
    ...
    why: {
      heading: "Go Direct to the Maker",
      body: "A custom ring shouldn’t come from a production line. It should come from someone who actually sits at the bench and makes it.",
      cardOne: "Boutee brings together some of the UK’s most talented independent jewellers. They work from their own small studios, handcraft each ring, and care about the story behind it.",
      cardTwo: "Because you’re working directly with the maker, you’re not paying for shop rent, sales staff or glossy displays. More of your budget goes into the ring itself — better materials, better finishing, better details.",
      cardThree: "Bring them your Pinterest board, a rough idea, or just a feeling. They’ll guide you through stone choices, metals and design tweaks until you land on a ring that feels “this is it”.",
