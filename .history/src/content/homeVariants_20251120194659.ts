...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "trusted-jewellers": createVariant({
    hero: {
      ...
      body: "Connect directly with vetted independent jewellers to craft your perfect ring, with no middlemen, mark-ups, or hidden fees. Experience a completely transparent, stress-free way to design an engagement ring, and enjoy total peace of mind throughout the process.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
      heading: "Your journey to the perfect ring, made simple",
      steps: [
        { title: "Define Your Style", description: "Like rings you love and tell us your preferences. Our platform builds your unique Style Profile, just like a personal shopper – only focused on your taste." },
    ...
    why: {
      heading: "Go direct to the maker",
      body: "Your ring should be made by a person, not a production line.",
      cardOne: "We’ve built a community of the UK’s most talented independent jewellers. Each has their own small workshop and is an expert craftsperson ready to turn your inspiration (yes, even a Pinterest board or sketch) into the perfect ring.",
      cardTwo: "Every ring is handcrafted and hallmarked for authenticity – no mass production, just genuine craftsmanship you can trust.",
      cardThree: "By going direct, you skip the middlemen and get a better ring at a better price.",
    ...
    bespoke: {
      ...
      timeDescription: "Every ring is designed and made to order, just for you, so it takes a bit of time to get everything perfect.",
    },
    testimonials: {
      heading: "Stories behind the rings",
    },
    cta: {
      ...
      body: "Create your free Style Profile to explore our community of vetted jewellers, get personalized matches based on your unique taste and budget, and chat directly with your chosen maker. It’s easy, transparent, and completely obligation-free.",
      buttonLabel: "Get Started for Free",
      buttonHref: "/app",
    },
  }),
