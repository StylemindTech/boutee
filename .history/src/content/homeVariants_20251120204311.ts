...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "no-sales-pressure": createVariant({
    hero: {
      badgeText: "Independent jewellers · No agendas · Straightforward guidance",
      heading: "A Better Way to Choose a Ring",
    ...
    why: {
      heading: "No Sales Layer. Just the Craftsperson.",
      body: "In most jewellery shops, the person you speak to isn’t the person making the ring. That’s where upselling and mark-ups creep in.",
      cardOne: "Boutee removes all of that.",
      cardTwo: "You speak directly to the maker — the person who’ll sketch your idea, source your stone, and craft the ring by hand. They care about the piece itself, not about shifting stock.",
      cardThree: "They’ll tell you what’s worth paying for, what isn’t, and how to get the best version of your idea without spending more than you planned. It’s honest by default.",
      ctaLabel: "XXXXXXXXX",
      ctaHref: "/app",
    },
    bespoke: {
    ...
    cta: {
      ...
      body: "Create your free Style Profile to see jewellers who fit your taste and budget. Look around quietly. Message when you’re ready. There’s no expectation to commit to anything.",
      buttonLabel: "Get Started for Free",
      buttonHref: "/app",
    },
  }),
