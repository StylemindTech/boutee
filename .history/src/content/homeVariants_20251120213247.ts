...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "bespoke-rings": createVariant({
    hero: {
      badgeText: "XXXXXXXXX",
      heading: "XXXXXXXXX",
      body: "If you want a ring that feels truly one-of-a-kind, you need the right craftsperson. Discover your design direction through simple swipes, then connect directly with an independent jeweller who specialises in creating bespoke rings from scratch.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
      heading: "XXXXXXXXX",
