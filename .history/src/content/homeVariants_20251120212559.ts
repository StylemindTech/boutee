...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "custom-rings": createVariant({
    hero: {
      ...
      body: "A custom ring shouldn’t start with guesswork. Browse designs to understand your style, then get matched with a jeweller who can explain options clearly and create the exact ring you want. No jargon, just a simple route to custom design.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
