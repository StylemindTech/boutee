...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "value-for-money": createVariant({
    ...
    hero: {
      badgeText: "60+ vetted jewellers, fair pricing",
      heading: "More sparkle.<br />Less spend.",
      body: "Get more ring for your money. Boutee matches you with independent jewellers who craft by hand and price honestly — no retail overheads, no sales tricks, no unnecessary markups. Build your Style Profile in minutes and discover makers who fit both your taste and your budget.",
      ctaLabel: "See value matches",
    },
    process: {
      heading: "High-quality rings,<br />without high mark-ups",
      steps: [
        {
          title: "Share your style & budget",
          description: "Like designs you love and set your budget. No pressure, just clarity.",
        },
        {
          title: "Get great-value matches",
          description: "We recommend independent jewellers who balance craftsmanship with fair pricing.",
        },
        {
          title: "Design direct, no markups",
          description: "Message your jeweller, agree the design and cost, and keep more value in the ring.",
        },
      ],
    },
    why: {
      heading: "Pay for craft, not overhead",
      body: "Work directly with a jeweller so your money goes into materials and skill—not a showroom.",
      cardOne:
        "Meet <strong>top independent jewellers</strong> crafting from their own workshops—no retail premiums.",
      cardTwo:
        "<strong>Transparent pricing</strong> with a maker who explains costs and options that suit your budget.",
      cardThree:
        "A better ring at a better price—<strong>skip the middlemen and keep more value</strong>.",
      ctaLabel: "Match with value makers",
      ctaHref: "/app",
    },
    bespoke: {
      heading: "Considering bespoke on a budget?",
      intro: "What to expect:",
      budgetValue: "From £1,000",
      budgetLabel: "realistic starting point",
      budgetDescription: "Keeps quality diamonds/metals while avoiding retail markups.",
      timeValue: "4-8",
      timeLabel: "weeks",
      timeDescription: "You get a made-for-you ring without rush fees or sales pressure.",
    },
    testimonials: {
      heading: "Great rings, fair prices",
      subheading: "Real couples who saved without compromising.",
    },
    cta: {
      heading: "Ready to find great value?",
      body: "Tell us your style and budget. We’ll match you with jewellers who maximise your spend.",
