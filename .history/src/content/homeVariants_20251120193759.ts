...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "trusted-jewellers": createVariant({
    hero: {
      ...
      body: "XXXXXXXXX",
      ctaLabel: "XXXXXXXXX",
      matchBadge: "XXXXXXXXX",
      jewellerName: "XXXXXXXXX",
      jewellerLocation: "XXXXXXXXX",
    },
    process: {
      heading: "XXXXXXXXX",
      steps: [
    ...
    bespoke: {
      heading: "XXXXXXXXX",
      intro: "XXXXXXXXX",
      budgetValue: "XXXXXXXXX",
      budgetLabel: "XXXXXXXXX",
    ...
    testimonials: {
      ...
      items: [
        { id: 1, review: "XXXXXXXXX", name: "XXXXXXXXX", location: "XXXXXXXXX" },
        { id: 2, review: "XXXXXXXXX", name: "XXXXXXXXX", location: "XXXXXXXXX" },
        { id: 3, review: "XXXXXXXXX", name: "XXXXXXXXX", location: "XXXXXXXXX" },
        { id: 4, review: "XXXXXXXXX", name: "XXXXXXXXX", location: "XXXXXXXXX" },
      ],
    },
    cta: {
      heading: "XXXXXXXXX",
