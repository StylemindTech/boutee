...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "bespoke-rings": createVariant({
    hero: {
      badgeText: "XXXXXXXXX",
      heading: "XXXXXXXXX",
      body: "If you want a truly one-of-a-kind ring, you need the right craftsperson. Swipe to build your Style Profile, then connect directly with an independent jeweller.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
      heading: "XXXXXXXXX",
