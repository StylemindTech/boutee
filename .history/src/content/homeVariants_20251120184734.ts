...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "value-for-money": createVariant({
    ...
    testimonials: {
      heading: "Stories Behind the Rings",
      subheading: "Real couples. Real makers. Real craftsmanship. See how independent jewellers turned budgets into meaningful, handcrafted rings — without retail markups.",
    },
    cta: {
