...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "trusted-jewellers": createVariant({
    hero: {
      ...
      body: "Connect directly with vetted independent jewellers to craft your perfect ring, with no middlemen, mark-ups, or hidden fees. Experience a completely transparent, stress-free way to design an engagement ring.",
      ctaLabel: "Find Your Jeweller",
    },
    process: {
