...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "value-for-money": createVariant({
    ...
    why: {
      ...
      cardOne:
        "When you buy through a retail chain, you pay for showrooms, sales staff and marketing — not better materials.",
      cardTwo:
        "With Boutee, you work directly with the jeweller who designs and crafts the ring at their bench. These award-winning makers produce exceptional work, but without the overheads of the high street.",
      cardThree:
        "<strong>The result?</strong> Ahandcrafted ring with higher craftsmanship and better materials — for the same budget you'd spend at a retailer.",
      ctaLabel: "Find Your Jeweller",
      ctaHref: "/app",
    },
    bespoke: {
