...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "bespoke-rings": createVariant({
    ...
    why: {
      ...
      cardTwo: "You’re matched with a jeweller whose style fits yours, so your ideas feel understood from the start. They guide you through details, proportions and materials with clarity and honesty.",
      cardThree: "By working directly with the maker, <strong>your budget goes into the ring itself — not retail mark-ups</strong> or branding. You get <strong>higher craftsmanship and better materials for the same spend</strong> you’d make at a big-name retailer.",
      ctaLabel: "Start Your Style Profile",
      ctaHref: "/app",
    },
    bespoke: {
