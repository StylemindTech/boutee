...
export const homeVariants: Record<string, HomeVariant> = {
  ...
  "no-pressure-shopping": createVariant({
    hero: {
      ...
      body: "Take your time. Browse styles freely. Choose a jeweller when you’re ready. Boutee gives you a simple, comfortable way to design an engagement ring — without the intensity of traditional jewellery shopping.",
    ...
    process: {
      ...
      steps: [
        ...
        { title: "See Your Matches", description: "We’ll show you independent jewellers whose design style suits your preferences and budget. Explore their work quietly on your phone, without the bustle of a shop floor or anyone steering you." },
        { title: "Start a Conversation", description: "Message a jeweller directly, whenever it suits you. They’re here to help you shape ideas, answer questions and guide you — at a pace that feels comfortable and natural." },
      ],
    },
    why: {
      heading: "Go Direct to the Maker",
      body: "When you work with an independent jeweller, the experience feels completely different from traditional retail.",
      cardOne: "There’s no hard sell — just a craftsperson talking you through options, materials and ideas with clarity and honesty.",
      cardTwo: "Every jeweller on Boutee runs their own small studio and cares deeply about the work they produce.",
      cardThree: "By going direct, you avoid retail overheads and get a ring made with real attention, transparency and care.",
      ctaLabel: "Find Your Jeweller",
      ctaHref: "/app",
    },
    bespoke: {
      ...
      budgetDescription: "A Budget of more than £1000 for high-quality, handcrafted work",
      timeDescription: "Enough time for design, creation ad hallmarking",
    },
    testimonials: {
      heading: "Stories Behind the Rings",
    },
