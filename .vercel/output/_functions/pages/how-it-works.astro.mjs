...
import { c as cardImg, a as cardImg1, b as cardImg2 } from '../chunks/card-img3_VSImYM6z.mjs';
export { renderers } from '../renderers.mjs';

const whoImg = new Proxy({"src":"/_astro/cta-img.DSVuadnk.png","width":620,"height":496,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/assets/Image/cta-img.png";
							}
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/components/how-it-works/CTASection.astro", void 0);
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/components/how-it-works/FaqSection.astro", void 0);

const heroImg = new Proxy({"src":"/_astro/user-img.CbODfUlA.jpg","width":1666,"height":2499,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/assets/Image/user-img.jpg";
							}
...
const heroImg1 = new Proxy({"src":"/_astro/Heart.tXc3ODHk.png","width":28,"height":28,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/assets/Image/Heart.png";
							}
...
const heroImgMobile = new Proxy({"src":"/_astro/ring-img.H64xG3sS.png","width":184,"height":209,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/assets/Image/ring-img.png";
							}
...
const heroImgMobile1 = new Proxy({"src":"/_astro/SetHero.GOclEObX.png","width":226,"height":195,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/assets/Image/SetHero.png";
							}
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/components/how-it-works/HeroSection.astro", void 0);

const $$ProcessSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="lg:py-[112px] py-[48px]"> <div class="max-w-screen-2xl lg:px-20 px-[24px] mx-auto"> <div class="overflow-hidden"> <h2 data-aos="fade-up" class="lg:text-[52px] text-[32px] font-figtree leading-[36px] font-black text-center lg:leading-[56px] text-textPrimary lg:mb-[80px] mb-[40px]">
The Boutee Process
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/components/how-it-works/ProcessSection.astro", void 0);

const $$StepSection = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="lg:py-[112px] py-[48px]"> <div class="max-w-screen-2xl lg:px-20 px-[24px] mx-auto"> <div class="grid md:grid-cols-2 md:gap-[80px] items-start"> <div> <h2 class="lg:text-[52px] font-figtree text-[32px] lg:leading-[56px] leading-[36px] lg:font-black font-normal text-center md:text-start md:mb-[40px] mb-[24px]">
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/components/how-it-works/StepSection.astro", void 0);
...
}, "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/pages/how-it-works.astro", void 0);

const $$file = "C:/Users/LAKHAN SINGH/OneDrive/Desktop/boutee/src/pages/how-it-works.astro";
