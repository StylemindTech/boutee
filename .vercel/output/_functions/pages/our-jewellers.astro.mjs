...
const img1 = new Proxy({"src":"/_astro/ourJewHero-1.9wPLCABg.jpg","width":1024,"height":1024,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/ourJewHero-1.jpg";
							}
...
const img2 = new Proxy({"src":"/_astro/ourJewHero-2.BBZWKNN8.jpg","width":914,"height":914,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/ourJewHero-2.jpg";
							}
...
const img3 = new Proxy({"src":"/_astro/ourJewHero-3.BF0vUHg7.jpg","width":2555,"height":1916,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/ourJewHero-3.jpg";
							}
...
OUR JEWELLERS
</div> <h1 class="md:text-[80px] md:mt-[48px] mt-[32px] text-[48px] text-center md:text-start leading-[42px] text-textPrimary font-black md:leading-[84px] font-ppradio md:mb-6 mb-[16px]">
...
}, "C:/Users/billy/boutee/src/components/our-jewellers/HeroSections.astro", void 0);
...
const cardImg = new Proxy({"src":"/_astro/jws-img.C9P1wT5i.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img.png";
							}
...
const cardImg1 = new Proxy({"src":"/_astro/jws-img-1.Cj5t2hWU.png","width":126,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-1.png";
							}
...
const cardImg2 = new Proxy({"src":"/_astro/jws-img-2.Bbb5HKJk.png","width":126,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-2.png";
							}
...
const cardImg3 = new Proxy({"src":"/_astro/jws-img-3.CIdq4F6I.png","width":126,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-3.png";
							}
...
const cardImg4 = new Proxy({"src":"/_astro/jws-img-4.B1_Xw-AV.png","width":126,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-4.png";
							}
...
const cardImg5 = new Proxy({"src":"/_astro/jws-img-5.B0XocaC6.png","width":766,"height":766,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-5.png";
							}
...
const cardImg6 = new Proxy({"src":"/_astro/jws-img-6.B8DgL1G3.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-6.png";
							}
...
const cardImg7 = new Proxy({"src":"/_astro/jws-img-7.CfScxsHg.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-7.png";
							}
...
const cardImg9 = new Proxy({"src":"/_astro/jws-img-9.k6QFHR2Y.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-9.png";
							}
...
const cardImg10 = new Proxy({"src":"/_astro/jws-img-10.C4fW4CJq.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-10.png";
							}
...
const cardImg11 = new Proxy({"src":"/_astro/jws-img-11.Bn4WJJI-.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-11.png";
							}
...
const cardImg12 = new Proxy({"src":"/_astro/jws-img-12.Dm3V_y-c.png","width":127,"height":132,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/billy/boutee/src/assets/Image/jws-img-12.png";
							}
...
}, "C:/Users/billy/boutee/src/components/our-jewellers/OurMakers.astro", void 0);

const $$JoinStep = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="lg:py-[112px] py-[48px]"> <div class="max-w-screen-2xl lg:px-20 px-[24px] mx-auto"> <div class="grid md:grid-cols-2 md:gap-[40px] items-start"> <div> <h2 class="lg:text-[52px] text-[32px] lg:leading-[56px] leading-[36px] lg:font-black font-normal text-center font-ppradio text-textPrimary md:text-start md:mb-[40px] mb-[24px]">
...
}, "C:/Users/billy/boutee/src/components/our-jewellers/JoinStep.astro", void 0);
...
}, "C:/Users/billy/boutee/src/components/our-jewellers/CTASection.astro", void 0);
...
}, "C:/Users/billy/boutee/src/pages/our-jewellers.astro", void 0);

const $$file = "C:/Users/billy/boutee/src/pages/our-jewellers.astro";
